  ...
  return (
    <div className="flex flex-col text-center justify-center">
      ...
      <p className="text-[16px] text-white opacity-50 w-[90%] md:w-[50%] mx-auto">
        ...
        facilis, sapiente laborum aspernatur vero iusto quasi quia eaque
        provident quod ratione harum. Eaque mollitia tenetur laborum minima
        officia aut distinctio?
      </p>
    </div>
  );
};
